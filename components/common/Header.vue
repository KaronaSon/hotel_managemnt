<template>
  <header class="bg-gray-800 text-white p-4 relative">
    <nav class="container mx-auto flex justify-between items-center">
      ...
      <NuxtLink to="/" class="flex items-center space-x-3 group transition duration-300">
        ...
        <div
          ...
          <img src="https://i.pinimg.com/736x/c1/51/e1/c151e1a742dea9d5f943383bc70f39be.jpg" alt="Sky Castle Logo"
            class="w-10 h-10 object-cover" />
        </div>

        <!-- Sky Castle Gradient Text -->
        <span :class="{ 'animate-fall': menuOpen }"
      ...
      <div class="space-x-4 hidden md:flex">
        <NuxtLink to="/" class="text-lg font-semibold text-gray-300 transition duration-300 focus:outline-none
        ...
        <NuxtLink to="/about" class="text-lg font-semibold text-gray-300 transition duration-300 focus:outline-none
                 hover:bg-gradient-to-r hover:from-indigo-400 hover:via-purple-400 hover:to-pink-400 
                 hover:bg-clip-text hover:text-transparent 
                 active:brightness-150 active:drop-shadow-[0_0_10px_rgba(255,255,255,0.8)]">
          About
    ...
    <div v-if="menuOpen"
      ...
      <NuxtLink to="/rooms/101" class="text-lg font-semibold text-gray-300 transition duration-300 focus:outline-none
               hover:bg-gradient-to-r hover:from-indigo-400 hover:via-purple-400 hover:to-pink-400 
               hover:bg-clip-text hover:text-transparent 
               active:brightness-150 active:drop-shadow-[0_0_10px_rgba(255,255,255,0.8)] px-4">
        Booking
      ...
      <NuxtLink to="/place-profile" class="text-lg font-semibold text-gray-300 transition duration-300 focus:outline-none
         hover:bg-gradient-to-r hover:from-indigo-400 hover:via-purple-400 hover:to-pink-400 
         hover:bg-clip-text hover:text-transparent 
         active:brightness-150 active:drop-shadow-[0_0_10px_rgba(255,255,255,0.8)] px-4">
        Profile
